"""
Kabi Nazrul Govt. College, Dhaka (KNC) Multi-Batch Automation Scraper
Website: https://knc.eshiksabd.com
Credentials: kncstudent / kncstudent
...
BASE_URL = "https://knc.eshiksabd.com"
REFERER  = f"{BASE_URL}/Result-Enquiry-Center"
COLLEGE_CODE = "knc"
COLLEGE_NAME = "Kabi Nazrul Govt. College, Dhaka"
FIXED_PREFIX = "120"
ROLL_DIGITS = 4
HAS_APPLICATION_FORM_DEFAULT = True
GROUPS = {
...
class PortalSession:
    ...
    def authenticate(self):
        ...
        with sync_playwright() as pw:
            ...
            page.locator("input[name=username]").fill("kncstudent")
            page.locator("input[name=password]").fill("kncstudent")
